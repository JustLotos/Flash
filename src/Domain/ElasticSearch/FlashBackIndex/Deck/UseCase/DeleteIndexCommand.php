...
{
    // docker-compose exec php bin/console app:es-delete-index
    protected static $defaultName = 'app:es-flash-deck-delete';
    ...
    {
        $result = $this->elasticService->deleteIndexAction();
